    ...
    return Row(
      ...
      children: [
        ...
        _ProgressCard(
          title: 'Seconds',
          child: BlocBuilder<AutomaticCounterBloc, AutomaticCounterState>(
            buildWhen: (previous, current) => current is ConsumingDurationState,
            builder: (context, state) {
              return _UsageProgress(
                text: (state is ConsumingDurationState ? state.duration : 0)
                    .toString(),
                value: state is ConsumingDurationState
                    ? 1 - (state.duration / maxSeconds)
                    : 1,
              );
            },
          ),
