...
class AppPadding {
  ...
  static const vertical50 = EdgeInsets.symmetric(vertical: 50);
  ...
  static const bottom100 = EdgeInsets.only(bottom: 100);
  ...
  static const right30 = EdgeInsets.only(right: 30);
  ...
  static const left30 = EdgeInsets.only(left: 30);
  static const left50 = EdgeInsets.only(left: 50);

  /// ListView
  static const listView = EdgeInsets.symmetric(horizontal: 8, vertical: 12);
